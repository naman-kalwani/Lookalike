...
[✨ Features](#-features) • [🚀 Quick Start](#-quick-start) • [📖 API Documentation](#-api-documentation) • [🏗️ Architecture](#️-architecture) • [🚀 Live Deployment](#️-live-deployment)
...
| `AI Embeddings` | Python (Flask + OpenAI CLIP) |
| `Storage` | Cloudinary (for product images) |
| `Hosting` | Frontend → Vercel<br>Backend → Render<br>CLIP API → Hugging Face Spaces |
...
| `CLIP API` | **Hugging Face Spaces** | https://huggingface.co/spaces/yourusername/lookalike-clip |
